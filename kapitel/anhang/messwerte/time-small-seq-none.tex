...
\midrule
    $\text{BPR}$ & 0.56 & 0.60 & {\color{green!60!black}0.58} & {\color{green!60!black}0.57} & {\color{green!60!black}0.51} & {\color{green!60!black}0.45} & {\color{green!60!black}0.58} & 0.71 & {\color{darkgray}--} & {\color{green!60!black}0.52} & {\color{green!60!black}0.59} & {\color{darkgray}--} & {\color{darkgray}--} & {\color{green!60!black}0.55} & {\color{green!60!black}0.55} \\
    $\text{BPR}_{\text{ref}}$ & {\color{green!60!black}0.51} & 0.53 & 0.67 & {\color{green!60!black}0.67} & {\color{green!60!black}0.53} & 0.50 & 0.77 & {\color{green!60!black}0.70} & {\color{darkgray}--} & 0.60 & 0.79 & {\color{darkgray}--} & {\color{darkgray}--} & {\color{green!60!black}0.59} & {\color{green!60!black}0.61} \\
    $\text{DC3}$ & 2.78 & 2.68 & 2.84 & 2.84 & 2.79 & 2.71 & 2.89 & 3.01 & {\color{darkgray}--} & 2.91 & 2.92 & {\color{darkgray}--} & {\color{darkgray}--} & 2.72 & 2.81 \\
    $\text{DC3-Lite}$ & {\color{red}24.30} & {\color{red}24.63} & {\color{red}8.63} & {\color{red}18.95} & {\color{red}21.35} & {\color{red}30.75} & 7.61 & 9.72 & {\color{darkgray}--} & 9.82 & 7.84 & {\color{darkgray}--} & {\color{darkgray}--} & {\color{red}23.16} & {\color{red}21.50} \\
    $\text{DC3}_{\text{ref}}$ & 4.83 & 4.21 & 4.67 & 5.50 & 5.46 & 4.75 & 3.91 & 3.93 & {\color{darkgray}--} & 4.27 & 4.10 & {\color{darkgray}--} & {\color{darkgray}--} & 5.25 & 5.43 \\
    $\text{DC7}$ & 3.59 & 3.64 & 3.77 & 3.72 & 3.65 & 3.46 & 3.94 & 4.14 & {\color{darkgray}--} & 3.83 & 3.95 & {\color{darkgray}--} & {\color{darkgray}--} & 3.61 & 3.68 \\
