...
\midrule
    $\text{BPR}$ & 0.56 & {\color{green!60!black}0.57} & 0.60 & {\color{green!60!black}0.58} & {\color{green!60!black}0.57} & {\color{green!60!black}0.51} & {\color{green!60!black}0.45} & {\color{green!60!black}0.58} & 0.71 & {\color{green!60!black}0.52} & {\color{green!60!black}0.59} & {\color{green!60!black}0.55} & {\color{green!60!black}0.55} \\
    $\text{BPR}_{\text{ref}}$ & {\color{green!60!black}0.51} & 0.72 & 0.53 & 0.67 & {\color{green!60!black}0.67} & {\color{green!60!black}0.53} & 0.50 & 0.77 & {\color{green!60!black}0.70} & 0.60 & 0.79 & {\color{green!60!black}0.59} & {\color{green!60!black}0.61} \\
    $\text{DC3}$ & 2.78 & 2.84 & 2.68 & 2.84 & 2.84 & 2.79 & 2.71 & 2.89 & 3.01 & 2.91 & 2.92 & 2.72 & 2.81 \\
    $\text{DC3-Lite}$ & {\color{red}24.30} & {\color{red}8.62} & {\color{red}24.63} & {\color{red}8.63} & {\color{red}18.95} & {\color{red}21.35} & {\color{red}30.75} & 7.61 & 9.72 & 9.82 & 7.84 & {\color{red}23.16} & {\color{red}21.50} \\
    $\text{DC3}_{\text{ref}}$ & 4.83 & 4.64 & 4.21 & 4.67 & 5.50 & 5.46 & 4.75 & 3.91 & 3.93 & 4.27 & 4.10 & 5.25 & 5.43 \\
    $\text{DC7}$ & 3.59 & 3.77 & 3.64 & 3.77 & 3.72 & 3.65 & 3.46 & 3.94 & 4.14 & 3.83 & 3.95 & 3.61 & 3.68 \\
    $\text{Deep-Shallow}$ & 4.91 & 1.82 & 1.68 & 1.82 & {\color{red}12.84} & 3.03 & 2.11 & {\color{darkgray}--} & {\color{red}41.90} & {\color{darkgray}--} & {\color{darkgray}--} & 1.64 & 1.45 \\
