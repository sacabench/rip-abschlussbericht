...
\midrule
    $\text{BPR}$ & 0.793 & 0.788 & 0.792 & 0.867 & 0.785 & 0.873 & 0.784 & 0.796 & 0.812 & 0.784 & 0.846 & 0.845 \\
    $\text{BPR}_{\text{ref}}$ & 3.331 & 3.327 & 3.328 & 3.405 & 3.323 & 3.411 & 3.321 & 3.335 & 3.351 & 3.321 & 3.385 & 3.384 \\
    $\text{DC3}$ & 3.119 & 3.079 & 3.116 & 3.121 & 3.111 & 3.119 & 3.116 & 3.121 & 3.122 & 3.116 & 3.079 & 3.105 \\
    $\text{DC3-Lite}$ & 1.563 & 1.563 & 1.563 & 1.563 & 1.563 & 1.563 & 1.563 & 1.563 & 1.563 & 1.563 & 1.563 & 1.563 \\
    $\text{DC3}_{\text{ref}}$ & {\color{red}4.660} & {\color{red}4.482} & {\color{red}4.647} & {\color{red}4.669} & {\color{red}4.627} & {\color{red}4.660} & {\color{red}4.647} & {\color{red}4.669} & {\color{red}4.675} & {\color{red}4.647} & {\color{red}4.482} & {\color{red}4.596} \\
    $\text{DC7}$ & 1.961 & 1.961 & 1.961 & 1.961 & 1.961 & 1.961 & 1.961 & 1.961 & 1.961 & 1.961 & 1.961 & 1.961 \\
    $\text{Deep-Shallow}$ & 0.002 & 0.002 & 0.002 & 0.003 & 0.002 & 0.003 & {\color{darkgray}--} & 0.005 & {\color{darkgray}--} & {\color{darkgray}--} & 0.003 & 0.003 \\
    $\text{Deep-Shallow\_bb}$ & 0.002 & 0.002 & 0.002 & 0.003 & 0.002 & 0.003 & {\color{darkgray}--} & 0.005 & {\color{darkgray}--} & {\color{darkgray}--} & 0.003 & 0.003 \\
    $\text{Deep-Shallow}_{\text{ref}}$ & 0.002 & 0.002 & 0.002 & 0.002 & 0.002 & 0.003 & 0.002 & 0.005 & {\color{green!60!black}0.002} & 0.002 & 0.002 & 0.002 \\
