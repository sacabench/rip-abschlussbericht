...
for @$i$@ = 1 up to @$n$@ do
	...
	while @$j$@ @$\neq$@ 0 do
		...
		@$j$@ @$\leftarrow$@ prev(@$j$@)
\end{minted}
\caption[Algorithmus zur Konstruktion eines Suffix Arrays f\ür einen gegebenen nullterminierten String $S$ der L\änge $n$]{Algorithmus zur Konstruktion eines Suffix Arrays f\ür einen gegebenen nullterminierten String $S$ der L\änge $n$}
\label{saca:3:code}
\end{figure}