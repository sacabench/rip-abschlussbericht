...
In der ersten Phase werden die Substrings \inputtext[i, i+2] sortiert, wobei $i$ ein Element aus dem Difference Cover \(D\) $=$ \{1, 2\} ist. Diese Phase haben wir in unserer Implementierung in zwei Teile aufgeteilt. Zuerst wird eine Liste von Triplets aufgestellt und diese wird dann im zweiten Teil der Phase sortiert.
