...
\begin{wrapfigure}[12]{R}[5mm]{.5\textwidth}
    ...
    \includegraphics[page=1, viewport=0cm 32.8cm 20.5cm 42.5cm, clip, width=.5\textwidth]{{kapitel/framework/cli/sacabench-list/sacabench-list}.pdf}\\
    \includegraphics[page=1, viewport=0cm 25cm 20.5cm 26.3cm, clip, width=.5\textwidth]{{kapitel/framework/cli/sacabench-list/sacabench-list}.pdf}\\
    \includegraphics[page=1, viewport=0cm 0cm 20.5cm 1.5cm, clip, width=.5\textwidth]{{kapitel/framework/cli/sacabench-list/sacabench-list}.pdf}
