...
\begin{wrapfigure}[30]{R}[5mm]{.5\textwidth}
    ...
    \includegraphics[page=1, viewport=0cm 32.8cm 20.5cm 68.5cm, clip, width=.5\textwidth]{{kapitel/framework/cli/sacabench-construct/sacabench-construct}.pdf}\\
    \includegraphics[page=1, viewport=0cm 25cm 20.5cm 26.3cm, clip, width=.5\textwidth]{{kapitel/framework/cli/sacabench-construct/sacabench-construct}.pdf}\\
    \includegraphics[page=1, viewport=0cm 0cm 20.5cm 1.5cm, clip, width=.5\textwidth]{{kapitel/framework/cli/sacabench-construct/sacabench-construct}.pdf}
...
Weitere Informationen hierzu sind in Kapitel \todo{Füge Kapitel aus anderem Branch hinzu} enthalten.
...
\input{kapitel/framework/cli/sacabench-construct-config}
