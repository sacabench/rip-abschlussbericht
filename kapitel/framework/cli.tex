...
\input{kapitel/framework/cli/sacabench}
\input{kapitel/framework/cli/sacabench-list}
\input{kapitel/framework/cli/sacabench-demo}
\input{kapitel/framework/cli/sacabench-construct}
\input{kapitel/framework/cli/sacabench-batch}
\input{kapitel/framework/cli/sacabench-plot}
