...
and \todo{diese Randbemerkung vllt weglassen}although our attempts were mostly not successful,
...
\todo{vllt erwähnen dass man seine eigenen Algorithmen einbinden kann?}
...
If there is already a file with the given name, it would be replaced by the new file.
...
This directly influenced qSufSort, which improved its performance by subdividing suffixes into sorted and unsorted groups. 
...
(and development of GPUs shows higher performance improvements than CPU development\todo{entweder belegen oder entfernen.}).
