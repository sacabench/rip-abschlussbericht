...
\noindent
Evaluation of both the sequential SACAs, including the reference algorithms, as well as of the parallel SACAs is done on LiDO3 \todo{Referenz}.
Our experiment texts are \texttt{wiki.txt} (a current XML-dump of Wikipedia),
...
In the \crefrange{ea:runtime-all-0}{ea:runtime-all-2} we show the performance of the implementations of different SACAs on a 1600 MiB prefix of the three texts.
