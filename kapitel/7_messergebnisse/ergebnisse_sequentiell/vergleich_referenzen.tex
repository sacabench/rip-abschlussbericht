...
Auf den Testdaten \texttt{wiki.txt} und \texttt{commoncrawl.txt} weisen die besten Laufzeiten die Implementierungen der DivSufSort\_ref und SAIS-LITE\_ref auf. Auf dem repetitiven Text \texttt{dna.txt} liegt der Deep-Shallow\_ref jedoch auf dem zweiten Platz. Die schlechtesten Algorithmen bezüglich der Laufzeit sind der DC3\_ref und der SADS\_ref.
