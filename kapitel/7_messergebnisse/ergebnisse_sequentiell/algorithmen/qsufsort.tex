...
Die Abbildungen \ref{qsufsort_benchmark:1}, \ref{qsufsort_benchmark:2} und \ref{qsufsort_benchmark:3} zeigen jeweils die Vergleiche zwischen unserer Implementierung des qSufSort, der Implementierung der Autoren Larsson und Sadakane und des naiven SACAs.
