...
\begin{figure}[ht]
    ...
    \caption{GSACA und GSACA\_ref auf wiki.txt}
    \label{GSACA-seq-0}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{GSACA und GSACA\_ref auf dna.txt}
    \label{GSACA-seq-1}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{GSACA und GSACA\_ref auf commoncrawl.txt}
    \label{GSACA-seq-2}
\end{figure}
\FloatBarrier

Die \currentauthor{David Piper} Abbildungen \ref{GSACA-seq-0}, \ref{GSACA-seq-1} und \ref{GSACA-seq-2} stellen den Suffix-Array-Kon\-struk\-ti\-ons\-al\-go\-rith\-mus GSACA der Referenzimplementierung und dem naiven SACA gegebnüber.
...
Auf allen drei Eingabetexten brechen sowohl GSACA als auch GSACA\_ref ab einer Eingabegröße von $1{,}6$ GiB ab.
Wie in \cref{messung:tab:sa-chk-large-seq-weak} ersichtlich ist, liegt dies dadran, dass GSACA das Speicherlimit des Systems überschreitet.
