...
In \currentauthor{Johannes Bahne} den \cref{fig-par-dc-0,fig-par-dc-1,fig-par-dc-2} sind die Implementierungen, die in dem \sacabench Framework umgesetzt worden sind, miteinander verglichen worden, die auf dem \emph{Difference Cover} basieren.
